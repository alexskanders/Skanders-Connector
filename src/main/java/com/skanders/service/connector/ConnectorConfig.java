...
public class ConnectorConfig extends RMSConfig
{
    public ConnectorConfig(RMSProperties prop)
    {
        super(prop);

        initIdmServiceConnector(prop);
    }

    private void initIdmServiceConnector(RMSProperties prop)
    {
